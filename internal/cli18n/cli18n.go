...
func init() {
	dict["en"] = map[string]string{
		...
		"doctor.ok": "OK  ",
		"doctor.recovery_wan_armed": "WARN recovery :8790 on 0.0.0.0 (armed DR window — OK; optional ALLOW_CIDR)",
		"doctor.recovery_loopback": "OK   recovery :8790 loopback only",
	...
	dict["ru"] = map[string]string{
		...
		"doctor.nvr_storage": "  storage: exists=%v writable=%v mount=%v free=%.1fGB segments=%d (%.2fGB)",
		"doctor.ok": "OK  ",
		"doctor.recovery_wan_armed": "WARN recovery :8790 на 0.0.0.0 (окно DR arm — норма; опционально ALLOW_CIDR)",
		"doctor.recovery_loopback": "OK   recovery :8790 только loopback",
