...
func init() {
	dict["en"] = map[string]string{
		...
		"doctor.ok": "OK  ",
		"doctor.recovery_wan_fail": "FAIL recovery :8790 on 0.0.0.0 (set NETDUCTOR_RECOVERY_BIND=127.0.0.1 or ALLOW_CIDR)",
	...
	dict["ru"] = map[string]string{
		...
		"doctor.nvr_storage": "  storage: exists=%v writable=%v mount=%v free=%.1fGB segments=%d (%.2fGB)",
		"doctor.ok": "OK  ",
		"doctor.recovery_wan_fail": "FAIL recovery :8790 на 0.0.0.0 (задайте NETDUCTOR_RECOVERY_BIND=127.0.0.1 или ALLOW_CIDR)",
