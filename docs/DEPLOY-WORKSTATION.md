...
Baseline: **v0.8.3**. Operator machine runs TUI as the **deployment centre**; VPS remains the control plane after install.
...
| Secondary agent | mTLS `:8789` (preferred) or plain `:8788` | Token always; mTLS when certs exist |
