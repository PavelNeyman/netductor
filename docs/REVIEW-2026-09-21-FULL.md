# Full review cycle — code · security · refactor · UI (v0.8.19)
...
|-------|----------|--------|
| Primary `nodes local-cmd upgrade` used **base64 bash** pinned to **v0.7.0-dev** | **High** | Replaced with pure Go upgrade using `deploy.Release` (0.8.19) |
...
| Admin | Strong (0.8.19) | data-i18n pass |
| CLI | doctor/vpn/mtls/help | cli18n |

`scripts/check-ui-parity.sh` — all groups **OK**  
`docs/UI-PARITY.md` — matrix  

## 5. Refactor plan (post-0.8.19)

| P | Item | Status |
|---|------|--------|
| P0 | Fix primary upgrade pin | **done 0.8.19** |
