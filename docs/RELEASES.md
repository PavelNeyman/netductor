...
Published tags (see GitHub Releases): **`v0.8.25`** (current), `v0.8.0`, older `v0.7.x` / `v0.5.x`.
...
```bash
export NETDUCTOR_VERSION=0.8.25
...
2. Tag: `git tag v0.8.25 && git push origin v0.8.2` — workflow on tag `v*`.
