...
- **0.8.27:** SA4000 doctor fix; dead code sweep; API status constants
 (0.8.17–0.8.27)
...
3. Reinstall drill with v0.8.27 binaries from Releases  

## Commands

```bash
brew reinstall netductor
netductor version   # 0.8.27
...
**Repo:** https://github.com/PavelNeyman/netductor  
**Release tag:** `v0.8.27` (check Releases if tag name differs)  
...
wget -qO /usr/local/bin/netductor \
  https://github.com/PavelNeyman/netductor/releases/download/v0.8.27/netductor-linux-amd64
...
## Current baseline — v0.8.27 (2026-09-20)

### Release
- Tag: **v0.8.27** · https://github.com/PavelNeyman/netductor/releases/tag/v0.8.27
- Assets: darwin/linux CLI, agent (amd64/arm/arm64/mipsle), tg, SHA256SUMS
- Homebrew Formula `0.8.27` · `brew reinstall netductor`
...
## Security review snapshot (v0.8.27)
...
4. **Hardcoded old download URLs** in some legacy docs/scripts (secondary self-update pin fixed to v0.8.27 in agent)
