...
3. Reinstall drill with v0.8.22 binaries from Releases  

## Commands

```bash
brew reinstall netductor
netductor version   # 0.8.22
...
**Repo:** https://github.com/PavelNeyman/netductor  
**Release tag:** `v0.8.22` (check Releases if tag name differs)  
...
## Current baseline — v0.8.22 (2026-09-20)

### Release
- Tag: **v0.8.22** · https://github.com/PavelNeyman/netductor/releases/tag/v0.8.22
- Assets: darwin/linux CLI, agent (amd64/arm/arm64/mipsle), tg, SHA256SUMS
- Homebrew Formula `0.8.22` · `brew reinstall netductor`
...
## Security review snapshot (v0.8.22)
...
4. **Hardcoded old download URLs** in some legacy docs/scripts (secondary self-update pin fixed to v0.8.22 in agent)
