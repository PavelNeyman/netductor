...
Baseline: **v0.8.1**. Full dual-node narrative: [DEPLOY.md](DEPLOY.md) · [FLEET.md](FLEET.md).

## 1. Install on Debian VPS
```bash
export NETDUCTOR_VERSION=0.8.1   # bootstrap default is 0.8.1; pin explicitly on reinstall
curl -fsSL https://raw.githubusercontent.com/PavelNeyman/netductor/main/bootstrap.sh | bash
# Or binary from https://github.com/PavelNeyman/netductor/releases/tag/v0.8.1
