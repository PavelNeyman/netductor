(() => {
  ...
  const i18n = {
    en: {
      ...
      edge_recovery_hint: 'LAN page on router: http://<router>:7879/netductor-recovery. Control: mTLS :8789 (client cert; no IP allowlist for NAT edge).',
    ...
    ru: {
      ...
      edge_recovery_hint: 'LAN-страница на роутере: http://<router>:7879/netductor-recovery. Control: mTLS :8789 (клиентский сертификат; IP-allowlist для NAT edge не используется).',
      ssh_hosts_title: 'SSH known hosts (TOFU)',
