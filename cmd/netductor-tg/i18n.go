...
var dict = map[string]map[string]string{
	"en": {
		...
		"main_menu":     "🏠 Main menu",
		"mtls":           "🔐 mTLS",
		"mtls_title":     "🔐 <b>mTLS certs</b>",
		"mtls_list":      "📋 List certs",
		"mtls_rotate_hint": "Send node id to rotate (auto-push)",
		"mtls_rollover_status": "📜 CA rollover status",
		...
		"admin_body":    "🖥 <b>Admin on Mac</b>\n\nFleet control UI is <b>netductor-op</b> (brew) on your Mac — not the bot and not a public panel on primary.\n\n• Session token below is for Shortcuts / API from VPN.\n• Optional legacy: SSH tunnel to <code>127.0.0.1:8787</code> only if you still use loopback admin.",
		...
		"nodes_hint":    "Format: <code>nd-&lt;role&gt;-&lt;marker&gt;</code>\nExamples: <code>nd-primary-nl01</code>, <code>nd-secondary-ru01</code>, <code>nd-edge-home</code>\nRoles: primary, secondary, edge, lab. Only a-z, 0-9, hyphen.",
		"nodes_empty":   "No nodes in registry.",
		"nodes_pick":    "Node: <b>%s</b>\nSend new hostname (e.g. nd-secondary-msk01):",
		"nodes_done":    "✅ desired set: <code>%s</code> → <code>%s</code>",
		"relay": "📡 Secondary",
		"relay_title": "📡 <b>RU Secondary</b>",
		"relay_export": "📦 Export join",
		"relay_oneline": "🧾 One-liner",
		"relay_list": "📋 Secondaries",
		...
		"edge_recovery": "🔑 Recovery code",
		"edge_register": "➕ Register device",
		"edge_recovery_done": "One-time code — open http://&lt;router&gt;:7879/netductor-recovery on site Wi‑Fi",
		"edge_register_prompt": "Send: <code>device_id</code> optional <code>site_id</code>",
		"edge_set_site_prompt": "Send: <code>device_id site_id</code>",
		"pending":       "⏳ Pending",
		"templates":     "📋 Templates",
		...
		"ssh_clear_rel": "Clear secondary",
		"ssh_cleared":   "Cleared",
		"ssh_forgot":    "Forgot: %s",
		"ssh_empty":     "(empty)",
		"nodes_list_btn": "📋 List",
		"nodes_rename_btn": "✏️ Rename",
		"nodes_enroll": "➕ Enroll secondary",
		"nodes_sync":    "🔄 Sync secondary",
		"nodes_exit":    "🇷🇺 RU exit",
		...
		"relay_exit_off": "✈️ RU exit OFF",
		"relay_sync":    "🔄 Sync secondary",
		...
		"enroll_pass": "Root password (once; then only operator SSH key):",
		"enroll_wait": "⏳ Provisioning <code>%s</code>… (1–3 min)",
		"ru_exit_help": "🇷🇺 <b>RU exit</b>\nWhen ON, traffic from primary exits via RU IP (RU services from abroad).",
		"back_vpn":      "⬅️ VPN",
	...
	"ru": {
		...
		"main_menu":     "🏠 Меню",
		"mtls":           "🔐 mTLS",
		"mtls_title":     "🔐 <b>mTLS сертификаты</b>",
		"mtls_list":      "📋 Список",
		"mtls_rotate_hint": "Пришлите node id для rotate (auto-push)",
		"mtls_rollover_status": "📜 Статус CA rollover",
		...
		"admin_body":    "🖥 <b>Админ на Mac</b>\n\nУправление флотом — <b>netductor-op</b> (brew) на Mac, не панель на primary.\n\n• Session-токен — для Shortcuts / API через VPN.\n• Опционально legacy: SSH-туннель на <code>127.0.0.1:8787</code>.",
		...
		"nodes_hint":    "Формат: <code>nd-&lt;role&gt;-&lt;marker&gt;</code>\nПримеры: <code>nd-primary-nl01</code>, <code>nd-secondary-ru01</code>, <code>nd-edge-home</code>\nРоли: primary, secondary, edge, lab. Только a-z, 0-9, дефис.",
		"nodes_empty":   "В реестре нет нод.",
		"nodes_pick":    "Нода: <b>%s</b>\nПришлите новое имя (например nd-secondary-msk01):",
		...
		"relay_oneline": "🧾 One-liner",
		"relay_list": "📋 Secondaries",
		"nodes_rename":  "✏️ <b>Переименовать</b>\n\nФормат: <code>nd-&lt;role&gt;-&lt;marker&gt;</code>\nПришлите: <code>id новое-имя</code>\nПример: <code>nd-primary-11870 nd-primary-nl01</code>",
		"cat_vpn":       "🔐 VPN",
		"cat_routers":   "📡 Роутеры",
		"cat_vpn_title": "🔐 <b>VPN</b>\nПользователи, ссылки, доступ.",
		"cat_routers_title": "📡 <b>Роутеры</b>\nУстройства, шаблоны, enroll.",
		"edge_recovery": "🔑 Recovery-код",
		"edge_register": "➕ Зарегистрировать",
		"edge_recovery_done": "Одноразовый код — на объекте: http://&lt;роутер&gt;:7879/netductor-recovery",
		"edge_register_prompt": "Пришлите: <code>device_id</code> и опционально <code>site_id</code>",
		"edge_set_site_prompt": "Пришлите: <code>device_id site_id</code>",
		"pending":       "⏳ Ожидают",
		"templates":     "📋 Шаблоны",
		...
		"ssh_clear_rel": "Очистить secondary",
		"ssh_cleared":   "Очищено",
		"ssh_forgot":    "Забыто: %s",
		"ssh_empty":     "(пусто)",
		...
		"relay_exit_on": "🇷🇺 RU-выход ВКЛ",
		"relay_exit_off": "✈️ RU-выход ВЫКЛ",
		"relay_sync":    "🔄 Синхр. secondary",
		...
		"enroll_pass": "Пароль root (один раз; дальше только SSH-ключ оператора):",
		"enroll_wait": "⏳ Настройка <code>%s</code>… (1–3 мин)",
		"ru_exit_help": "🇷🇺 <b>RU exit</b>\nЕсли ВКЛ — трафик с primary выходит через IP РФ (доступ к RU-сервисам из-за границы).",
		"back_vpn":      "⬅️ VPN",
