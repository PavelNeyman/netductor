...
func nvrHubHTML() string {
	...
	b.WriteString(`<tg-button type="callback_data" style="primary" data="m:nvr:cams">📷</tg-button>`)
	b.WriteString(`<tg-button type="callback_data" style="link" data="m:nvr:sites">📍</tg-button>`)
	b.WriteString(`<tg-button type="callback_data" style="link" data="m:nvr:cfg">⚙️</tg-button>`)
	b.WriteString(`<tg-button type="callback_data" style="link" data="m:nvr:rotate">🗜</tg-button>`)
	b.WriteString(`</tg-button-row>` + nl)
	b.WriteString(`<tg-button-row align="left">`)
	b.WriteString(`<tg-button type="callback_data" style="link" data="m:nvr:segs">📼</tg-button>`)
	b.WriteString(`<tg-button type="callback_data" style="link" data="m:nvr:events">⚡</tg-button>`)
	b.WriteString(`<tg-button type="callback_data" style="link" data="m:nvr:motion">👁</tg-button>`)
	b.WriteString(`<tg-button type="callback_data" style="link" data="m:nvr:go2rtc">📡</tg-button>`)
	b.WriteString(`</tg-button-row>` + nl)
	return b.String()
}
